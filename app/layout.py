...
def create_standard_chart_container(chart):
    ...
    return html.Div([
        ...
        dbc.Button(
            ...
            color="link",
            className="btn-close-fullscreen position-absolute",
            style={"display": "none", "top": "0.5rem", "right": "0.5rem"}
        )
    ], className="border p-4 m-0 g-0 position-relative", style={"minHeight": "420px"})
